    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.headerText}>AUTOPARTES</Text>
            </View>
            // cards
            <View style={styles.card}>
                {/* <Image style={styles.img} source={require('./PEDI.png')} /> */}
                <Text style={styles.text}>Todas las Autopartes</Text>
            </View>
            <View style={styles.card}>
                {/* <Image style={styles.img} source={require('./VENTAS.png')} /> */}
                <Text style={styles.text}>Autoparte por Subcategoria</Text>
            </View>
        </View>
    )
}
